...
export declare class DatePickerComponent {
    ...
    setView(view: DatePickerView, index: number | string, total: number | string, scrolledElement: HTMLElement): void;
    onCancel(): void;
    onDone(): void;
    limitTo(arr: Array<string> | string, limit: number): Array<string> | string;
    monthShort(arr: Array<string> | string): Array<string> | string;
    dayOfWeekShort(arr: Array<string> | string): Array<string> | string;
    nextMonth(): void;
    prevMonth(): void;
